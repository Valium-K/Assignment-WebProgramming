...
public class Entity4Test {
    ...
    private Entity4 savedEntity4;


    @Before
    public void init() {
        savedEntity4 = entity4Repository.save(Entity4.builder()
                .company("(주)홍길동")
                .position("개발자")
    ...
    public void testFindCompany() {
        ...
        List<Entity4> findCompany2 = entity4Repository.findAllByCompany("(주)회사");
    ...
    public void testFindEndDate() {
        ...
        List<Entity4> findEndDate2 = entity4Repository.findAllByEndDate(new Date(2019, 3, 19));
